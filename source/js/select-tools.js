...
let LamSelectTools = (function () {
  ...
  let getSelectTemplate = function (template, layer) {
    ...
    str += "</td>";
    if (layerRelations.length) {
      str += "<td><a class='lam-pointer' onclick='LamSelectTools.toggle(this)'>Relazioni</a><div class='lam-hidden'>";
      if (layerRelations.length) str += LamTemplates.relationsTemplate(layerRelations, null, null);
      str += "</div></td>";
    }
    if (layerCharts.length) {
      str += "<td><a class='lam-pointer' onclick='LamSelectTools.toggle(this)'>Grafici</a><div class='lam-hidden'>";
